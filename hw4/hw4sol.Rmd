...
```
*Report starts here*
# Title: 30-Day Mortality Rate of Pnemonia Patients Admitted to CCU
<!-- or maybe influenza? -->
## 1. Introduction

## 2. Data Preparation

The table `d_icd_diagnoses` stores all types of diagnosis and corresponding codes, and thus the influenza-related diagnosis are extracted.
```{r}
